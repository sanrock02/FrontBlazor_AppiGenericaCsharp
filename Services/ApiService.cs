    ...
    public class ApiService
    {
        ...
        private List<Dictionary<string, object?>> ConvertirDatos(JsonElement datos)
        {
            ...
            foreach (var fila in datos.EnumerateArray())
            {
                ...
                {
                    // Detectar si esta propiedad debería ser una fecha de manera eficiente
                    bool esFecha = propiedadesFecha.Any(p => propiedad.Name.Contains(p, StringComparison.OrdinalIgnoreCase));
